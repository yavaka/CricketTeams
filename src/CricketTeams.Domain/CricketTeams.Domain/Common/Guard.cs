namespace CricketTeams.Domain.Common
{
    ...
    public static class Guard
    {
        ...
        public static void AgainstNegativeValue<TException>(int actualValue, string name = "Value")
            where TException : BaseDomainException, new()
        {
            if (actualValue >= 0)
            {
        ...
        public static void AgainstNegativeValue<TException>(decimal actualValue, string name = "Value")
            where TException : BaseDomainException, new()
        {
            if (actualValue >= 0)
            {
